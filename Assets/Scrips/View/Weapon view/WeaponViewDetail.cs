    ...
    private void SetInfo()
    {
        ...
        if (wp_data != null)
        {
            ...
            else
            {
                ...
                price_lb.text = cf_weapon_level_next.Price.ToString();
                ...
                s_rof_next = "-><color=#00ffffff>" + cf_weapon_level_next.ROF.ToString() + "</color>" ;
        ...
        //reload
        reload_val_.text = cf_weapon.Reload.ToString();
    }
    public void OnEquip()
    {
        EquipWeaponDialogParam param = new EquipWeaponDialogParam();
        param.id_new_wp = cf_weapon.id;
       // DialogManager.instance.ShowDialog(DialogIndex.EquipWeaponDialog, new EquipWeaponDialogParam { id_new_wp = cf_weapon.id });
