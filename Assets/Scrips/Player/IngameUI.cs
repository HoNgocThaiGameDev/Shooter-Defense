...
public class IngameUI : BySingleton<IngameUI>
{
    ...
    IEnumerator Start()
    {
        ...
        // btn_click.onClick.AddListener(OnClickDemo);
    ...
    private void OnChangeGun(WeaponBehaviour wp)
    {
        ...
        //1
        // iconGun.overrideSprite = Resources.Load("Icon/" + wp.gun_name, typeof(Sprite)) as Sprite;
        //2
    ...
    private void OnDisable()
    {
        ...
        // WeaponControl.instance.OnChangeGun_2 -= OnChangeGun_2;
        //  btn_click.onClick.RemoveListener(OnClickDemo);
    }
