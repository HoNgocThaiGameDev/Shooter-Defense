...
public class QuestManager : BySingleton<QuestManager>
{
    ...
    public void InitQuest(ConfigMissionRecord cf_mission)
    {
        ...
        if (missionData.star_1 == false)
        {
            ...
            GameObject quest_object_1 = Instantiate(Resources.Load("Quest/" + quest_1.Type.ToString(), typeof(GameObject))) as GameObject;
        ...
        if (missionData.star_2 == false)
        {
            ...
            GameObject quest_object_2 = Instantiate(Resources.Load("Quest/" + quest_2.Type.ToString(), typeof(GameObject))) as GameObject;
        ...
        if (missionData.star_3 == false)
        {
            ...
            GameObject quest_object_3 = Instantiate(Resources.Load("Quest/" + quest_3.Type.ToString(), typeof(GameObject))) as GameObject;
